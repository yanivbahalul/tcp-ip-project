...
פרויקט צ'אט מבוסס TCP/IP עם ממשק גרפי (GUI) בסגנון Y2K.
...
### Server GUI
- ממשק ניהול שרת עם לוגים בזמן אמת
- תצוגת משתמשים מחוברים
- אנימציית Deadpool ברקע
- כפתור לבדיקת משתמשים אונליין

### Client GUI
- ממשק צ'אט ידידותי עם עיצוב Y2K
- רשימת משתמשים אונליין
- בחירת משתמש לצ'אט אחד-על-אחד
- היסטוריית הודעות לפי משתמש
- אנימציית Deadpool ברקע
- Marquee עם ציטוטים בראש המסך
...
- במחשב הלקוח: הכנס את כתובת ה-IP של מחשב השרת (לדוגמה: `10.0.0.12`)
